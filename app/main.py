...
from app.core.system.telemetry import setup_metrics
from app.core.system.middleware import (
...
async def lifespan(app: FastAPI):
    ...
    # Here we will close DB connections or flush LangFuse buffers
    langfuse.flush()
...
async def rate_limit_exceeded_handler(request: Request, exc: Exception):
    """Handle rate-limit violations with a FastAPI-friendly handler signature."""
